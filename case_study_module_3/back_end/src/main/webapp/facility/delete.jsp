                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly style="border-radius: 30px" type="text" class="form-control" name="name"
                                   placeholder="name *" value="${facility.getName()}"/>
                        </div>
                        <br>
                        <div class="form-group">
                            <label>Area</label>
                            <input readonly style="border-radius: 30px" type="text" class="form-control" name="area"
                        ...
                        <div class="form-group">
                            ...
                            <input readonly style="border-radius: 30px" type="text" class="form-control" name="cost"
