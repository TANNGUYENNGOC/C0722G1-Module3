...
<div class="container-fluid vh-100">
    ...
    <div class="row d-flex" style="height: 60%;margin-bottom: 10px">
        ...
        <div class="col-xl-6">
            ...
            <form class="row d-flex" method="post" action="/customer?action=add">
                <div class="col-5">
                    <div class="form-outline mb-4">
                        <input name="customerTypeId" type="text"  class="form-control form-control-lg" placeholder="Customer type id*"/>
                    </div>
                    <div class="form-outline mb-4">
