...
<div class="container-fluid vh-100">
    ...
    <div class="row d-flex" style="height: 60%;margin-bottom: 10px">
        ...
        <div class="col-xl-6">
            <h2 class="text-uppercase text-center mb-5">UPDATE ${customer.getName()}</h2>
            <form class="row d-flex" method="post" action="/customer?action=update">
                <div class="col-5">

                    <div class="form-outline mb-4">
                        <input  name="customerTypeId" type="text"  class="form-control form-control-lg"
                    ...
                    <div class="form-outline mb-4">
                        <input  name="dateOfBirth" type="text"  class="form-control form-control-lg"
                               value="${customer.getDateOfBirth()}"/>
                    </div>
                    <div class="form-outline mb-4">
                        <input  name="Gender" type="text"  class="form-control form-control-lg"
                ...
                <div class="col-5">
                    <div class="form-outline mb-4">
                        <input  name="idCard" type="text"  class="form-control form-control-lg"
                               value="${customer.getIdCard()}"/>
                    </div>
                    <div class="form-outline mb-4">
                        <input  name="phoneNumber" type="text"  class="form-control form-control-lg" value="${customer.getId()}"/>
                    </div>
                    <div class="form-outline mb-4">
